...
@if(isset($results))
    ...
    @php $i++; @endphp
        ...
        <a href="/cms/categories/delete/{{$r->id}}/" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
        
        </div>
        <div class="col-lg-2" style="text-align:right;">
        <a href="/cms/categories/recovery/{{$r->id}}" class="btn btn-default">إستعادة</a>
        </div>
